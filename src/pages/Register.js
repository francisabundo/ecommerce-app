	...
	return(
		...
		:	
			<Form className="mt-5"  onSubmit={(e) => registerUser(e)}>
				...
				{
					isActive ?
						<Button variant="danger" type="submit" id="submitBtn" className="mt-2">Register</Button>
						:
						<Button variant="danger" type="submit" id="submitBtn" className="mt-2" disabled>Register</Button>
				}
